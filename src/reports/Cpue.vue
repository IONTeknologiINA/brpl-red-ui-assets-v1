...
export default {
  ...
  methods: {
    ...
    getWpp: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.CPUE}/wpp`, this.formForAsync());
    ...
    getResources: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.CPUE}/resources`, this.formForAsync());
    ...
    getLocations: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.CPUE}/locations`, this.formForAsync());
