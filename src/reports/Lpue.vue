...
export default {
  ...
  methods: {
    ...
    getWpp: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.LPUE}/wpp`, this.formForAsync());
    ...
    getResources: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.LPUE}/resources`, this.formForAsync());
    ...
    getLocations: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.LPUE}/locations`, this.formForAsync());
    ...
    generate: async function () {
      ...
      this.axios.post(`${this.$RED.HOST}/${this.$RED.LPUE}`, body)
          .then(({data}) => {
