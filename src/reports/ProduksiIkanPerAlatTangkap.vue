...
export default {
  ...
  name: "ProduksiIkanPerAlatTangkap",
  ...
  methods: {
    ...
    getWpp: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_ALAT_TANGKAP}/wpp`, this.formForAsync());
    ...
    getResources: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_ALAT_TANGKAP}/resources`, this.formForAsync());
    ...
    getLocations: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_ALAT_TANGKAP}/locations`, this.formForAsync());
