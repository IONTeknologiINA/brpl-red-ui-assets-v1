...
export default {
  ...
  name: "ProduksiIkanPerSumberDaya",
  ...
  methods: {
    ...
    getWpp: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_SUMBER_DAYA}/wpp`, this.formForAsync());
    ...
    getResources: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_SUMBER_DAYA}/resources`, this.formForAsync());
    ...
    getLocations: async function () {
      const {data} = await this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_SUMBER_DAYA}/locations`, this.formForAsync());
    ...
    generate: async function () {
      ...
      this.axios.post(`${this.$RED.HOST}/${this.$RED.PRODUKSI_IKAN_PER_SUMBER_DAYA}`, body)
          .then(({data}) => {
